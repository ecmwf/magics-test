...
for row in rows:
    ...
    values = [ele for ele in row[1:] if ele != 1.7e308]
...
boxplot = mboxplot(
    boxplot_date_positions=data["FOR_PROBABILISTIC"]["DATE"],
    boxplot_minimum_values=[x - 50.0 for x in data["FOR_PROBABILISTIC"]["QMIN"]],
    boxplot_maximum_values=[x + 50.0 for x in data["FOR_PROBABILISTIC"]["QMAX"]],
    boxplot_box_upper_values=[x + 50.0 for x in data["FOR_PROBABILISTIC"]["Q75"]],
