...
polar = mmap(
    subpage_upper_right_longitude=11.13,
    subpage_upper_right_latitude=64.0,
    subpage_lower_left_longitude=-12.0,
    subpage_map_projection="polar_stereographic",
    subpage_lower_left_latitude=48.11,
)
polar = mmap(
    subpage_upper_right_longitude=2.5,
...
# Setting the coordinates of the geographical area
area = mmap(
    subpage_upper_right_longitude=35.0,
    subpage_upper_right_latitude=80.0,
...
data = mgrib(grib_input_file_name="wind_reduced_gg.grib", grib_id="z500")
...
wind = mwind(
    ...
    wind_thinning_factor=8.0,
    wind_thinning_debug="off",
)

title = mtext(
    text_lines=[
        "<font size='1'>Wind arrows with legend</font>",
        "",
