...
streamlines = mwind(
    ...
    wind_streamline_min_density=4.0,
    wind_streamline_thickness=1,
)
wind = mwind(wind_arrow_unit_velocity=25.00, wind_arrow_colour="red")

title = mtext(
    text_lines=["<font size='1'>Streamlines</font>"],
