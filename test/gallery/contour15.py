...
# Setting output
output = output(
    output_formats=["png"], output_name="contour15", output_name_first_page_number="off"
)
...
contour = mcont(
    ...
    contour_shade_colour_list=[
        "rgb(1.00,0.35,0.00),rgb(1.00,  0.55,  0.00)",
        "rgb(1.00,  0.67,  0.00)",
        "rgb(1.00,  0.78,  0.00)",
        "rgb(1.00,  0.89,  0.00)",
        "rgb(1.00,  1.00,  0.00)",
...
title = mtext(
    text_lines=[
        '<font size="1">CAPE - Shade from 100 to 4500 (orange-blue)</font>',
        "<magics_title/>",
    ],
