...
projection1 = mmap(
    ...
    subpage_y_length=1.0,
    subpage_frame="off",
    subpage_map_projection="cartesian",
    subpage_x_axis_type="date",
    subpage_y_axis_type="regular",
    subpage_x_date_min="2017-06-01",
    subpage_x_date_max="2017-08-01",
    subpage_y_min=-20.0,
    subpage_y_max=20.0,
)
...
vertical = maxis(axis_orientation="vertical", axis_grid="on")
...
title5 = mtext(
    text_lines=[
        "<font size='0.8'> Automatic Method to setup labelling of date axis: [axis_date_type = </font><font size='0.8' colour='navy'>automatic</font><font size='0.8'>]</font>",
