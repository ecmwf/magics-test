...
input = minput(
    ...
    input_y_values=y,
    input_x_component_values=[50.0, 0.0, -50.0],
...
symbol = msymb(legend="off", symbol_type="wind", wind_arrow_colour="red")


title = mtext(
    text_lines=["Using Wind as  symbol ..."],
...
# To the plot
plot(
    output, projection, vertical, horizontal, input, symbol, title,
)

# For documentation only
tofortran(
    ref, projection, vertical, horizontal, input, symbol, title,
)
tomv4(ref, input)
