...
y1 = numpy.array([35.0, 45.0, 40.0, 45.0, 40.0, 30.0, 35.0, 45.0,])
y2 = y1 + 5
y3 = y1 + 10

solid_input = minput(input_date_x_values=x, input_y_values=y1)
...
# define  the  data
dot_input = minput(
    input_date_x_values=x, input_date_x2_values=x, input_y_values=y1, input_y2_values=y2
)
...
# define  the  data
hatch_input = minput(
    input_date_x_values=x, input_date_x2_values=x, input_y_values=y2, input_y2_values=y3
)
...
tohtml(
    ref, solid_input, solid, dot_input, dot,
)
