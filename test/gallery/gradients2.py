...
projection = mmap(subpage_map_projection="robinson", subpage_x_length=25.0)
...
list = mcont(
    ...
    contour_gradients_colour_list=[
        "RGB(0.031,0.188,0.420",
        "RGB(0.031,0.318,0.612",
        "RGB(0.976,0.984,0.992)",
        "RGB(1.000,0.969,0.925)",
        "RGB(0.702,0.000,0.000)",
        "RGB(0.498,0.000,0.000)",
    ],
    # contour_gradients_colour_list = ["red", "blue", "green",
    #            "yellow", "red", "green", ],
    contour_gradients_technique="hsl",
    contour_level_list=[-50.0, -25, -5, +5, 25, 50.0],
...
legend = mlegend(
    ...
    legend_values_list=[-50.0, -40, -25, 0, 25, 40, 50.0],
...
# To the plot
plot(
    output, projection, data, list, coast, title, legend,
)
