...
bottom = numpy.array([30.0, 30.0, 30.0])
left = numpy.array([45.0, 45.0, 45.0])
right = numpy.array([60.0, 60.0, 60.0])
top = numpy.array([75.0, 75.0, 75.0])
middle = numpy.array([90.0, 90.0, 90.0])


topinput = minput(input_x_type="date", input_date_x_values=x, input_y_values=top)
...
leftinput = minput(input_x_type="date", input_date_x_values=x, input_y_values=left)
...
rightinput = minput(input_x_type="date", input_date_x_values=x, input_y_values=right)
...
bottominput = minput(input_x_type="date", input_date_x_values=x, input_y_values=bottom)
...
centreinput = minput(input_x_type="date", input_date_x_values=x, input_y_values=middle)
