...
input1 = minput(input_y_values=y, input_date_x_values=x)
...
y = numpy.array([60.0, 70.0, 30.0])

input2 = minput(input_y_values=y, input_date_x_values=x)
# Define the graph
curve2 = mgraph(
...
tofortran(
    ref, output, projection, vertical, horizontal, input1, curve1, input2, curve2, title
)
