...
data = mwrepjson(
    wrepjson_family="eps",
    wrepjson_input_filename="wind_direction.json",
    wrepjson_parameter="249.140",
    wrepjson_parameter_information="Wind direction",
)
...
plot(
    output, roseprojection, horizontal, vertical, data, rose, title,
)
