...
# Loading GRIB file
data = mgrib(
    grib_input_file_name="700_hPa_relative_humidity.grib", grib_field_position=1
)

# Setting output
output = output(
    output_formats=["png"], output_name="contour17", output_name_first_page_number="off"
)
...
title = mtext(
    text_lines=[
        '<font size="1">700 hPa relative humidity (Range: 65 .. 100)</font>',
        "<magics_title/>",
    ],
