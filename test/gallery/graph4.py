...
y_min = numpy.array([30.0, 35.0, 50.0])
y_max = numpy.array([60.0, 40.0, 70.0])

input_line = minput(
    input_y_values=y_min,
...
y = numpy.array([60.0, 40.0, 30.0])

input_annotation = minput(
    input_y_values=y,
    input_y2_values=[0.0, 0.0, 0.0],
    input_date_x_values=x,
    input_date_x2_values=x,
)
# Define the graph
annotation = mgraph(
    ...
    graph_bar_annotation=[
        "<font colour='red'>red result</font>",
        "result",
        "<font colour='evergreen'>green result</font>",
    ],
...
tohtml(
    ref, input_line, line, input_annotation, annotation,
)
