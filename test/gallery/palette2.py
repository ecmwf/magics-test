...
# Setting the output
output = output(
    output_formats=["png"], output_name=ref, output_name_first_page_number="off"
)
...
contour = mcont(
    ...
    contour_level_list=[0.0, 5.0, 15.0, 25.0, 50.0, 100.0, 300.0],
    contour_shade="on",
...
title = mtext(
    text_lines=[
        '<font size="1">Using predefined palette</font>',
        "contour_shade_colour_method = 'palette'",
        "contour_shade_palette_name = 'm_alt_rainbow2_6'",
        "Total precipitation",
    ],
