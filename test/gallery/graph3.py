...
input_centre = minput(input_y_values=y, input_date_x_values=x,)
# Define the graph
centre = mgraph(
    graph_type="bar",
...
input_right = minput(input_y_values=y, input_date_x_values=x,)
...
input_left = minput(input_y_values=y, input_date_x_values=x,)
