...
t850 = mgrib(grib_input_file_name="t850.grb", grib_field_position=1)
...
zero = mcont(
    legend="off",
    contour_min_level=-1.0,
    contour_max_level=1.0,
    contour_level_selection_type="level_list",
    contour_level_list=[0.0],
...
title = mtext(
    text_lines=[
        "Positive values are <font colour='red'>red </font>",
