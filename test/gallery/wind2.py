...
australia = mmap(
    ...
    subpage_upper_right_latitude=-5.0,
    subpage_lower_left_longitude=100.0,
    subpage_map_projection="cylindrical",
    subpage_lower_left_latitude=-55.0,
)
...
speed200_contour = mcont(
    ...
    contour_hilo_suppress_radius=30.0,
    contour_hi_min_value=15.0,
    contour_label="off",
)
...
title = mtext(
    text_lines=["<font size='1'>Wind flags where speed is over 20 m/s</font>"],
...
legend = mlegend(
    ...
    legend_box_y_position=4.0,
    legend_box_x_length=2.0,
    legend_box_y_length=12.0,
    legend_border="off",
