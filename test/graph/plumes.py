...
tempe_contour = mcont(
    ...
    contour_level_list=[0.5, 10.0, 30.0, 50.0, 100.0],
...
lines = [
    "ECMWF Ensemble forecasts <json_info key='station_name'/>",
...
title = mtext(
    ...
    text_box_y_position=7.0,
    text_box_x_length=10.0,
...
precip = mwrepjson(
    ...
    wrepjson_parameter_scaling_factor=1000.0,
