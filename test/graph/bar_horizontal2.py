...
# define  the  data
y = numpy.array([15.0, 20.0, 25.0])
x = numpy.array([35.0, 45.0, 55.0])

input_centre = minput(input_y_values=y, input_x_values=x,)
# Define the graph
centre = mgraph(
    graph_type="bar",
...
# define  the  data
y = numpy.array([35.0, 40.0, 45.0])
x = numpy.array([60.0, 40.0, 30.0])

input_right = minput(input_y_values=y, input_x_values=x,)
...
# define  the  data
y = numpy.array([55.0, 60.0, 65.0])
x = numpy.array([60.0, 40.0, 30.0])

input_left = minput(input_y_values=y, input_x_values=x,)
