...
page1 = page(
    ...
    page_x_length=20.0,
    page_y_length=5.0,
    page_y_position=21.0,
    page_id_line="off",
    subpage_y_length=4.0,
...
data1 = mepsinput(
    epsxml_input_filename="raqgramdata_%s.xml" % (param1,),
    epsxml_parameter=param1,
    epsxml_long_title="on",
)
box1 = mepsgraph(
    eps_box_border_colour="black",
...
data2 = mepsinput(
    epsxml_input_filename="raqgramdata_%s.xml" % (param2,),
...
data3 = mepsinput(
    epsxml_input_filename="raqgramdata_%s.xml" % (param3,),
...
data4 = mepsinput(
    epsxml_input_filename="raqgramdata_%s.xml" % (param4,),
