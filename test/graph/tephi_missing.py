...
projection = mmap(subpage_y_position=2.0, subpage_map_projection="tephigram",)
...
td = minput(
    input_x_values=[-6.0, -16, -14, -27, -56, 1.7e38, -71, -69, 1.7e38],
    input_y_values=[675.0, 500, 0.0, 400, 280, 214, 200, 180, 155],
)
...
plot(
    output, projection, tephi, td, graph,
)
