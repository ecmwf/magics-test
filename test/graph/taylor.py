...
projection = mmap(
    subpage_map_projection="taylor",
    subpage_frame="off",
    taylor_standard_deviation_min=0.0,
    taylor_standard_deviation_max=2.0,
)
...
grid = mtaylor(
    ...
    taylor_primary_grid_reference=1.0,
    ...
    taylor_secondary_grid_reference=1.0,
