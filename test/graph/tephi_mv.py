...
output = output(
    output_formats=["png"], output_name_first_page_number="off", output_name="tephi_mv"
)
...
wind_plot = mwind(wind_field_type="flags", wind_flag_colour="black")

plot(
    output, projection, tephi, tempe, tempe_graph, td, td_graph, wind, wind_plot,
)
