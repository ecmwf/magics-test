...
text.append(
    "Probability of precipitation type (%) depending on mean precipitation rates (mm/h)"
)
text.append(
...
text.append(
    "Rain (mm/h)------------------Sleet(mm/h)----------------Wetsnow (mm/h)--------------Snow (mm/h)-------------Icepellets (mm/h)-------------------Freezing"
)
