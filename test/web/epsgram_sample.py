...
roseprojection = mmap(
    ...
    subpage_y_min=-43000.0,
    subpage_y_max=43000.0,
...
cc_clim = mwrepjson(
    ...
    wrepjson_parameter="164.128",
    wrepjson_parameter_scaling_factor=8.0,
    wrepjson_parameter_information="Total cloud cover",
)

cc_shade = mepsshading(
    eps_shade_colour="Rgb(0.925, 0.609, 0.953)", eps_shade_line_thickness=4
)
...
cc_graph = mepsgraph(
    eps_box_border_colour="Rgb(0.5, 0.5, 0.5)",
