...
projection = mmap(subpage_map_projection="cylindrical", page_id_line="off")

# Coastlines setting

coast = mcoast(map_grid="on", map_grid_colour="tan", map_coastline_colour="tan")
...
title = mtext(
    text_lines=[
        "<font size='1'>Reduced Gaussain Grid...</font>",
