...
projection = mmap(
    ...
    subpage_x_position=3.0,
    subpage_map_projection="cartesian",
    subpage_x_axis_type="geoline",
    subpage_y_axis_type="logarithmic",
    subpage_x_min_latitude=-20.0,
    subpage_x_max_latitude=20.0,
    subpage_x_min_longitude=-180.0,
    subpage_x_max_longitude=180.0,
    subpage_y_min=1.0,
    subpage_y_max=50000000.0,
)
